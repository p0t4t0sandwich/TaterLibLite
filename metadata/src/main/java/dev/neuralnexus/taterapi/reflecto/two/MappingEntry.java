...
public record MappingEntry(
    ...
    public static Builder builder(final @NonNull String value) {
        return new Builder().value(value);
    }

    public static Builder builder(final @NonNull Mappings mappings, final @NonNull String value) {
        return new Builder().value(value).mappings(mappings);
    }

    public static Builder builder(
            final @NonNull String value, final @NonNull Mappings... mappings) {
        return new Builder().value(value).mappings(mappings);
    }
